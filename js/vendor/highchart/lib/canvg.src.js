 ...
 */
 (function ( global, factory ) {
	...
	if ( typeof define !== 'undefined' && define.amd ) {
		define('canvgModule', [ 'se/js/vendor/highchart/lib/rgbcolor', 'stackblur' ], factory );
	}

	// ...or as browserify
	else if ( typeof module !== 'undefined' && module.exports ) {
		module.exports = factory( require( 'se/js/vendor/highchart/lib/rgbcolor' ), require( 'stackblur' ) );
	}
